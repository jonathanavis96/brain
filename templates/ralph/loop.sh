...
#
# Monorepo support:
# - In a monorepo layout (repo root contains both `brain/` and a sibling app such as `website/`), set ROOT
#   to the repo root so RovoDev can read/write across projects.
