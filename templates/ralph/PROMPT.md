...
- For last THUNK number: `tail -20 THUNK.md | grep "^|" | tail -1`
...
```bash
grep -n "^- \[ \]" IMPLEMENTATION_PLAN.md | head -10
```
...
sed -n '230,260p' IMPLEMENTATION_PLAN.md
```
