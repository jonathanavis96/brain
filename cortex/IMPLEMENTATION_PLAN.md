...
### Task 38.2: Simplify entrypoints ("Start Here" - Planning)


---

### Task 38.2: Simplify entrypoints ("Start Here" - Implementation)


---

### Task 38.3: Prune or demote historical docs (Part 1)
...
- **AC:** `README.md` includes a concise “Start Here” section linking to: `NEURONS.md`, `docs/TOOLS.md`, `docs/BOOTSTRAPPING.md`, `skills/SUMMARY.md`, and `workers/workers/IMPLEMENTATION_PLAN.md`.
- **If Blocked:** Add the section as a TODO skeleton with placeholder bullets.


---

### Task 38.3: Prune or demote historical docs (Part 2)
...
### Task 38.4: Cross-link consistency + naming conventions (Part 1)
