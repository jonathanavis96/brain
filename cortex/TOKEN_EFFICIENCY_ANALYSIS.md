...
4. R4: Deduplicate NEURONS.md (~500 tokens per Ralph iteration)
5. R5: Extract examples to reference docs (~400 tokens)

**Phase 3 (Future - Maintenance):**
6. R6: DECISIONS.md archiving (prevents bloat)
