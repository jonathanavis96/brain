...
- **Location**: Absolute path where the project should be created (e.g., `/home/grafe/code/my-project`)
...
4. Invokes HIGH INTELLIGENCE generators to create custom:
   ...
   - `IMPLEMENTATION_PLAN.md` (prioritized tasks from goals)
...
- `ralph/` - Complete Ralph loop infrastructure
  ...
  - `IMPLEMENTATION_PLAN.md` - Custom prioritized tasks (generated by HIGH INTELLIGENCE)
