...
1. Open a terminal and run: `bash workers/cerebras/current_cerebras_tasks.sh`
...
1. Open a terminal and run: `bash workers/cerebras/thunk_cerebras_tasks.sh`
...
5. Check `workers/cerebras/workers/ralph/THUNK.md` - it should NOT be auto-updated
...
Then run verifier to confirm: `cd workers/cerebras && bash verifier.sh`
