...
- **Code fences:** Always include language tag (```bash, ```markdown, ```python)
...
- **0-B:** Copy `brain/ralph/` → `brain/workers/ralph/` (test copy works)
- **0-C:** Human verifies new location, runs full test suite
- **0-D:** Delete old `brain/ralph/` (Ralph runs from new location)
