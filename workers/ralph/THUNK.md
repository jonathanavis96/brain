...
| 397 | 2.2 | HIGH | **2.2** Line 246 - Split declaration and assignment for SC2155 (SH-3, SH-9, SH-16) - Fixed by separating local declaration from assignment, shellcheck now passes with 0 SC2155 violations | 2026-01-22 || 398 | 2.2 | HIGH | **2.2** Line 246 - Split declaration and assignment for SC2155 (SH-3, SH-9, SH-16) - Fixed by separating local declaration from assignment, shellcheck now passes with 0 SC2155 violations | 2026-01-22 || 399 | 2.2 | HIGH | **2.2** Line 246 - Split declaration and assignment for SC2155 (SH-3, SH-9, SH-16) - Fixed by separating local declaration from assignment using regex pattern, shellcheck now passes with 0 SC2155 violations | 2026-01-22 || 400 | 2.2 | HIGH | **2.2** Line 246 - Split declaration and assignment for SC2155 (SH-3, SH-9, SH-16) - Fixed by separating local declaration from assignment using regex pattern, shellcheck now passes with 0 SC2155 violations | 2026-01-22 || 401 | 2.2 | HIGH | **2.2** Line 246 - Split declaration and assignment for SC2155 (SH-3, SH-9, SH-16) - Fixed by separating local declaration from assignment using regex pattern, shellcheck now passes with 0 SC2155 violations | 2026-01-22 |
...
| 443 | WARN.MD.17.skills | MEDIUM | **WARN.MD.17.skills** Fix MD violations in `skills/domains/websites/qa/acceptance-criteria.md` - Fixed 20+ markdown violations using Python script: MD060 (table spacing - added spaces around pipes in separator lines), MD022 (blank lines around headings - added blank lines before/after ### headings), MD031 (blanks around fences - added blank lines before/after code blocks), MD034 (bare URLs - wrapped schema.org and opengraph.xyz URLs in angle brackets), markdo
| 444 | WARN.MD.22.skills | LOW | **WARN.MD.22.skills** Fix MD violations in `skills/conventions.md` - Fixed 22 markdown violations: MD032 (blanks around lists - added blank lines before/after all lists), MD036 (emphasis as heading - converted **bold** section labels to #### headings), MD040 (fence language tags - added `text` tag to directory tree and code example end marker), MD026 (trailing punctuation in headings - removed colons from "when:" headings), MD038 (spaces in code spans - removed backticks from inline code in formatting description), MD029 (ordered list prefix - renumbered step 2 to step 1 in example), MD031 (blanks around fences - added blank lines before code block) | 2026-01-23 |wnlint now passes with 0 violations | 2026-01-23 |
...
| 450 | WARN.MD.29.skills | LOW | **WARN.MD.29.skills** Fix MD violations in `skills/domains/backend/error-handling-patterns.md` - Fixed MD032 (blanks around lists - added blank lines before/after 4 lists at lines 11, 22, 180, 186), MD031 (blanks around fences - added blank lines before/after 5 code blocks at lines 951, 970, 988, 1007, 1024), MD036 (emphasis as heading - converted 3 bold patterns to #### headings at lines 422, 451, 468), MD060 (table spacing - converted 4 tables from aligned to compact style with `| --- |` separator lines), markdownlint now passes with 0 errors (34 violations resolved) | 2026-01-23 |
...
| 490 | 0.C.9 | HIGH | **0.C.9** Test sync end-to-end - Fixed bug in sync_cortex_plan.sh line 120 (added `head -1` to handle duplicate marker lines), added dummy Phase 99 to Cortex plan, ran sync script (7 sections added including Phase 99), verified no duplicate sections created (`grep "^## Phase" | sort | uniq -d` returned empty), removed Phase 99 from both plans, synced template (diff shows no output). Sync system works correctly: one-way append-only, exact header matching, no duplicates. | 2026-01-23 |
