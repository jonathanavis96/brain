...
| 443 | WARN.MD.17.skills | MEDIUM | **WARN.MD.17.skills** Fix MD violations in `skills/domains/websites/qa/acceptance-criteria.md` - Fixed 20+ markdown violations using Python script: MD060 (table spacing - added spaces around pipes in separator lines), MD022 (blank lines around headings - added blank lines before/after ### headings), MD031 (blank lines around fences - added blank lines before/after code blocks), MD034 (bare URLs - wrapped schema.org and opengraph.xyz URLs in angle brackets), markdownlint now passes with 0 violations | 2026-01-23 |
