...
| 443 | WARN.MD.17.skills | MEDIUM | **WARN.MD.17.skills** Fix MD violations in `skills/domains/websites/qa/acceptance-criteria.md` - Fixed 20+ markdown violations using Python script: MD060 (table spacing - added spaces around pipes in separator lines), MD022 (blank lines around headings - added blank lines before/after ### headings), MD031 (blanks around fences - added blank lines before/after code blocks), MD034 (bare URLs - wrapped schema.org and opengraph.xyz URLs in angle brackets), markdownlint now passes with 0 violations | 2026-01-23 |
...
| 446 | WARN.MD.20.skills | MEDIUM | **WARN.MD.20.skills** Fix MD violations in `skills/domains/websites/architecture/sitemap-builder.md` - Fixed MD032 (blank line before list at line 17), MD040 (added language tags to 4 fenced code blocks: text for nav hierarchy and patterns), MD022 (added blank lines before 3 headings in Navigation Patterns section), MD031 (added blank lines before/after 3 code fences), MD060 (fixed table separator spacing in 2 tables using compact style with spaces around pipes), markdownlint now passes with 0 violations | 2026-01-23 |
