...
These were discovered during pre-commit scans and relate to the separation work:
...
## Phase 5: Cortex Plan Sync (from cortex/IMPLEMENTATION_PLAN.md)

Tasks synced from Cortex that aren't covered above:
