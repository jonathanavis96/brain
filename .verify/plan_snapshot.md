...
## Phase MD-1: Markdown Lint Fixes - RALPH LOOP FULL EXAMPLE.md

**Goal:** Fix markdown lint errors in `cortex/docs/RALPH LOOP FULL EXAMPLE.md` that could not be auto-fixed.

**Reference:** Markdown lint output from loop.sh auto-fix run (2026-01-26)

**Status:** 31 errors identified across multiple rule types. Ready for BUILD phase execution.

### Multiple Blank Lines (MD012)

- [ ] **MD-1.1** Fix MD012 at line 24 (Expected: 2; Actual: 3)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD012 errors at line 24)

- [ ] **MD-1.2** Fix MD012 at lines 133-134 (Expected: 2; Actual: 3-4)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD012 errors at lines 133-134)

- [ ] **MD-1.3** Fix MD012 at lines 315-316 (Expected: 2; Actual: 3-4)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD012 errors at lines 315-316)

- [ ] **MD-1.4** Fix MD012 at lines 382-383 (Expected: 2; Actual: 3-4)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD012 errors at lines 382-383)

- [ ] **MD-1.5** Fix MD012 at line 434 (Expected: 2; Actual: 3)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD012 errors at line 434)

### Code Block Style (MD046)

- [ ] **MD-1.6** Fix MD046 at line 28 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 28)

- [ ] **MD-1.7** Fix MD046 at line 42 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 42)

- [ ] **MD-1.8** Fix MD046 at line 56 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 56)

- [ ] **MD-1.9** Fix MD046 at line 86 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 86)

- [ ] **MD-1.10** Fix MD046 at line 248 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 248)

- [ ] **MD-1.11** Fix MD046 at line 268 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 268)

- [ ] **MD-1.12** Fix MD046 at line 286 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 286)

- [ ] **MD-1.13** Fix MD046 at line 292 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 292)

- [ ] **MD-1.14** Fix MD046 at line 309 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 309)

- [ ] **MD-1.15** Fix MD046 at line 367 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 367)

- [ ] **MD-1.16** Fix MD046 at line 376 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 376)

- [ ] **MD-1.17** Fix MD046 at line 416 (Expected: fenced; Actual: indented)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD046 errors at line 416)

### Spaces in Code Spans (MD038)

- [ ] **MD-1.18** Fix MD038 at line 140:21 (spaces inside code span elements)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD038 errors at line 140)

- [ ] **MD-1.19** Fix MD038 at line 145:1 (spaces inside code span elements)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD038 errors at line 145)

- [ ] **MD-1.20** Fix MD038 at line 152:1 (spaces inside code span elements)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD038 errors at line 152)

- [ ] **MD-1.21** Fix MD038 at line 166:1 (spaces inside code span elements)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD038 errors at line 166)

- [ ] **MD-1.22** Fix MD038 at line 181:1 (spaces inside code span elements)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD038 errors at line 181)

- [ ] **MD-1.23** Fix MD038 at line 188:1 (spaces inside code span elements)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD038 errors at line 188)

- [ ] **MD-1.24** Fix MD038 at line 191:1 (spaces inside code span elements)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD038 errors at line 191)

### Heading Issues (MD003, MD022, MD023)

- [ ] **MD-1.25** Fix MD023 at line 439 (heading must start at beginning of line)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD023 errors at line 439)

- [ ] **MD-1.26** Fix MD023 at line 445 (heading must start at beginning of line)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD023 errors at line 445)

- [ ] **MD-1.27** Fix MD003/MD022 at line 445 (setext heading style + blank line issues)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD003/MD022 errors at line 445)

- [ ] **MD-1.28** Fix MD003/MD022 at line 449 (setext heading style + blank line issues)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD003/MD022 errors at line 449)

### List Issues (MD007, MD032)

- [ ] **MD-1.29** Fix MD007/MD032 at line 441 (list indentation + blank lines)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD007/MD032 errors at line 441)

- [ ] **MD-1.30** Fix MD007/MD032 at line 443 (list indentation + blank lines)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD007/MD032 errors at line 443)

- [ ] **MD-1.31** Fix MD007/MD032 at line 444 (list indentation + blank lines)
  - **AC:** `markdownlint "cortex/docs/RALPH LOOP FULL EXAMPLE.md"` passes (no MD007/MD032 errors at line 444)
